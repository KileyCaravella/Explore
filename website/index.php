...
<div id="find_random" class="w3-modal">
    <div class="w3-modal-content w3-card-8 w3-animate-zoom w3-padding-jumbo" style="max-width:600px">
        <div class="w3-container w3-white w3-center">
            <span onclick="document.getElementById('find_random').style.display='none'"
                  class="w3-closebtn w3-hover-text-grey w3-margin">x</span>
...
<div class="tab w3-pale-red w3-center w3-padding-32">
    <div class="w3-section">
        <h3>Get Started!</h3>
        <button onclick="openCity(event, 'random'); document.getElementById('find_random').style.display='block'"
                class="tablinks; w3-button w3-round" style="padding:12px 30px">Find Random
        </button>
        <button onclick="openCity(event, 'browsecategory'); document.getElementById('category').style.display='block'"
                class="tablinks; w3-button w3-round" style="padding:12px 30px">Browse Your Categories
        </button>
    </div>
    ...
    <div id="checkforget" class="w3-modal">
        <div class="w3-modal-content w3-card-8 w3-animate-zoom w3-padding-jumbo" style="max-width:600px">
            <div class="w3-container w3-white w3-center">
                <span onclick="document.getElementById('checkforget').style.display='none'"
                      class="w3-closebtn w3-hover-text-grey w3-margin">x</span>
    ...
    <div id="pickcategories" class="w3-modal">
        <div class="w3-modal-content w3-card-8 w3-animate-zoom w3-padding-jumbo" style="max-width:600px">
            <div class="w3-container w3-white w3-center">
                <span onclick="document.getElementById('pickcategories').style.display='none'"
                      class="w3-closebtn w3-hover-text-grey w3-margin">x</span>
                ...
                <div class="w3-section">
                    ...
                    <button onclick="document.getElementById('new_categories').style.display='block'; document.getElementById('pickcategories').style.display='none'"
                            class="w3-btn w3-round" style="padding:8px 20px">New Category
                    </button>
                </div>
            </div>
        </div>
            ...
            <div class="w3-container w3-center">
                <div class="w3-card-4 w3-dark-grey">
                    <div class="w3-container w3-center">
                        ...
                        <br/>
                        <div class="w3-section">
                            <button onclick="document.getElementById('pickcategories').style.display='block'"
                                    class="w3-button w3-round w3-green">Save
                            </button>
                            <button class="w3-button w3-round w3-light-grey">Next</button>
                            <button onclick="document.getElementById('checkforget').style.display='block'"
                                    class="w3-button w3-round w3-red">Forget
                            </button>
                        </div>
                    </div>
                </div>
